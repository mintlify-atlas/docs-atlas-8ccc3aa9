---
title: 'Changelog'
description: 'Release history and changes for HAI Build Code Generator'
---
...
- Merged changes from Cline 3.56.2 (see [changelog](https://github.com/cline/cline/blob/main/CHANGELOG.md#3560)).
...
- Merged changes from Cline 3.55.0 (see [changelog](https://github.com/cline/cline/blob/main/CHANGELOG.md#3550)).
...
<Note>
For the complete upstream Cline changelog, visit the [Cline repository](https://github.com/cline/cline/blob/main/CHANGELOG.md).
</Note>